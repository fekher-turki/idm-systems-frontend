...
@Component({
    selector: 'app-moderator-expense-report',
    templateUrl: './moderator-expense-report.component.html',
    styleUrls: ['./moderator-expense-report.component.scss'],
...
export class ExpenseReportComponent implements OnInit {
    ...
    reloadData() {
        this.expenseReports = this.expenseReportService.getModExpenseReportList(this.user);
