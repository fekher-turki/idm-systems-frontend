...
@Component({
    selector: 'app-financial-detail-expense-report',
    templateUrl: './financial-detail-expense-report.component.html',
    styleUrls: ['./financial-detail-expense-report.component.scss'],
